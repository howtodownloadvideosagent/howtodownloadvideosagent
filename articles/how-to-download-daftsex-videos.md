...
Site name: daftsex
Domain: daftsex.net
Article path: content/site-articles/daftsex-net.md
...
```text
Attempted URL: https://daftsex.net/
Final URL: https://daftsex.net/
HTTP status: 200
...
yt-dlp homepage stderr: ERROR: Unsupported URL: https://daftsex.net/
...
```bash
URL="https://daftsex.net/path/to/video"
...
```bash
page_url="https://daftsex.net/path/to/video"
...
```bash
ffmpeg -i "input-from-daftsex-net.ext" -map 0 -c copy -movflags +faststart "daftsex-net-fixed.mp4"
```
