...
Site name: Manporn
Domain: manporn.com
Article path: content/site-articles/manporn-com.md
...
```text
Attempted URL: https://manporn.com/
Final URL: https://hotguys.com/
HTTP status: 200
Content-Type: text/html; charset=utf-8
Bytes read: 35404
Fetch error: none observed
HTML title: Hot Guys - Free Gay Sex Cams &amp; Gay Webcam Adult Chat - Web Cam Video Chat
```
...
yt-dlp homepage stderr: ERROR: Unsupported URL: https://hotguys.com/
yt-dlp homepage duration_seconds: 1.45
```
...
```bash
URL="https://manporn.com/path/to/video"
...
```bash
page_url="https://manporn.com/path/to/video"
...
```bash
ffmpeg -i "input-from-manporn-com.ext" -map 0 -c copy -movflags +faststart "manporn-com-fixed.mp4"
```
