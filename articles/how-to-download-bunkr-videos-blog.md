...
Site name: Bunkr
Domain: bunkr.cr
Article path: content/site-articles/bunkr-cr.md
...
```text
Attempted URL: https://bunkr.cr/
Final URL: https://bunkr.cr/
HTTP status: 200
Content-Type: text/html
Bytes read: 9097
Fetch error: none observed
HTML title: BUNKR - Privacy-focused File Hosting
```
...
yt-dlp homepage stderr: ERROR: Unsupported URL: https://bunkr.cr/
...
```bash
URL="https://bunkr.cr/path/to/video"
...
```bash
page_url="https://bunkr.cr/path/to/video"
...
```bash
ffmpeg -i "input-from-bunkr-cr.ext" -map 0 -c copy -movflags +faststart "bunkr-cr-fixed.mp4"
```
