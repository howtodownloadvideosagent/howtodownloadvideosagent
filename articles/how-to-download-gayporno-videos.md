...
Site name: gayporno
Domain: gayporno.fm
Article path: content/site-articles/gayporno-fm.md
...
```text
Attempted URL: https://gayporno.fm/
Final URL: https://www.gayporno.fm/
HTTP status: 200
Content-Type: text/html; charset=UTF-8
Bytes read: 246728
Fetch error: none observed
HTML title: Free Gay XXX Porn Tube - GayPorno.fm
```
...
yt-dlp homepage stderr: ERROR: Unsupported URL: https://www.gayporno.fm/
...
```bash
URL="https://gayporno.fm/path/to/video"
...
```bash
page_url="https://gayporno.fm/path/to/video"
...
```bash
ffmpeg -i "input-from-gayporno-fm.ext" -map 0 -c copy -movflags +faststart "gayporno-fm-fixed.mp4"
```
