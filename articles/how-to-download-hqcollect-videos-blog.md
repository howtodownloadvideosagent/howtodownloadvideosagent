...
CSV row: 381
Site name: hqcollect
Domain: hqcollect.net
Article path: content/site-articles/hqcollect-net.md
...
```text
Attempted URL: https://hqcollect.net/
Final URL: https://gloryholeswallow.com/tour/
HTTP status: 200
Content-Type: text/html; charset=UTF-8
Bytes read: 32135
Fetch error: none observed
HTML title: GloryholeSwallow | The Real Gloryhole Experience!
```
...
yt-dlp homepage stdout: html5	HTML5MediaEmbed	tour-1	The Real Gloryhole Experience! (1)
yt-dlp homepage stderr: none observed
yt-dlp homepage duration_seconds: 3.83
```
...
```bash
URL="https://hqcollect.net/path/to/video"
...
```bash
page_url="https://hqcollect.net/path/to/video"
...
```bash
ffmpeg -i "input-from-hqcollect-net.ext" -map 0 -c copy -movflags +faststart "hqcollect-net-fixed.mp4"
```
